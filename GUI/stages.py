...
class Openning:
    ...
    Attributes:
        ...
        alert_label (Label): The label for displaying alert messages.
        

    Methods:
        __init__(): Initializes the Openning object.
        display_alert(alert: str) -> None: Displays an alert message in Openning.
        clear_alert() -> None: Clears the alert label by setting its text to an empty string.
        handle_events(event: pygame.event.Event) -> int: Handles the events generated by user interactions.
        get_config() -> Config: Returns the loaded configuration.
        update() -> None: Updates the display of the GUI.
    """
    def __init__(self):
        """
...
class Setting:
    """
    Represents the setting stage of the card game designer.
    This class takes user input and sets up the game configuration.
    Users have the option to save this configuration and start playing.
    ...
    Methods:
        __init__(): Initializes the Setting object.
        display_alert(alert: str) -> None: Displays an alert message in Setting.
        clear_alert() -> None: Clears the alert label by setting its text to an empty string.
        handle_events(event: pygame.event.Event) -> int: Handles the events generated by user interactions.
        get_config() -> Config: Returns the current game configuration.
        update() -> None: Updates the display of the Setting stage.
    """
    ...
    def display_alert(self, alert: str) -> None:
        """
        Displays an alert message in the Setting stage.
    ...
    def handle_events(self, event: pygame.event.Event) -> int:
        """
        Handles the events for the Setting stage.
    ...
    def get_config(self) -> Config:
        ...
        Returns:
            Config: The configuration from the setting GUI.
        """
...
class Game:
    ...
    Attributes:
        ...
        draw_button (Button): The draw button sprite.
        draw_flag (bool): The flag indicating whether drawing cards is allowed.
        end_button (Button): The end button sprite.
        end_flag (bool): The flag indicating whether the game has ended.
        fini_button (Button): The finish button sprite.
        alert_label (Label): The label for displaying alert messages.
        current_player_label (Label): The label for displaying the current player.
    ...
    Methods:
        ...
        handle_events(self, event: pygame.event.Event) -> int:
            Handles the events in the game.
        display_player_cards(self, database: CardDatabase, player: str = "player1", height:int=500, 
                             scale:tuple=(100, 150)) -> None:
            Display the cards in player's hand.
        display_current_player(self, player: str) -> None:
            Display the current player.
        display_back_cards(self, database: CardDatabase, player:str="cp", height:int=30, 
                           scale:tuple=(60, 100)) -> None:
            Display the cards in cp's hand.
        display_community_cards(self, database: CardDatabase) -> None:
            Display the cards in community.
        display_recently_played_cards(self, database: CardDatabase) -> None:
            Display the recently played cards.
        check_input(self, input: str, config: Config) -> list[str]:
    ...
    def __init__(self, config: dict = None) -> None:
        ...
        Args:
            config (dict, optional): The configuration object containing game settings. Defaults to None.
        """
        self.width, self.height = WIDTH, HEIGHT
        self.screen = pygame.display.set_mode((self.width, self.height))
    ...
    def display_player_cards(self, database: CardDatabase, player: str = "player1", height:int=500, 
        ...
        Args:
            ...
            player (str, optional): The player whose cards will be displayed. Defaults to "player1".
            height (int, optional): The height at which the cards will be displayed. Defaults to 500.
            scale (tuple, optional): The scale of the card images. Defaults to (100, 150).
        """
    ...
    def display_back_cards(self, database: CardDatabase, player:str="cp", height:int=30, 
        ...
        Args:
            database (CardDatabase): The card database.
                                    Get the cards in hand. 
            player (str, optional): The player whose cards will be displayed. Defaults to "cp".
            height (int, optional): The height at which the cards will be displayed. Defaults to 30.
            scale (tuple, optional): The scale of the card images. Defaults to (60, 100).
        """
        cards=database.hands[player]
        num_cards=len(cards)
    ...
    def check_input(self, input: str, config: Config) -> list[str]:
        ...
        Returns:
            list: A list of integer strings representing the valid input.
    ...
    def update(self, database: CardDatabase, config: Config, game_end: bool = False) -> None: 
        ...
        Args:
            ...
            game_end (bool, optional): Flag indicating if the game has ended. Defaults to False.
        """
    ...
    def is_end(self, database: CardDatabase) -> bool:
        ...
        Calling customizable function end_game() to check if the game has ended.
        
        Args:
            database (CardDatabase): The card database used in the game.
